      ...
      try {
         ...
         if (res.ok) {
            ...
            try {
               ...
               if (
                  error?.error ===
                  'This email is already in use. Try something else.'
               ) {
            ...
            <div className="flex flex-col  w-[288px] gap-4">
               ...
               >
                  <div className="flex flex-col gap-1 ">
                     ...
                     >
                        {error || 'We will be verifying this mail'}
                     </label>
                  </div>
                  <div className="flex flex-col gap-1 ">
                     <div className="relative w-full flex items-center justify-center">
                        <input
                           className={`h-[40px] py-1 px-3 bg-lightGrey text-black  text-sm rounded-lg border  focus:ring-2 focus:bg-lightPurple   ring-purple outline-none w-full border-[#DFDDE3] `}
