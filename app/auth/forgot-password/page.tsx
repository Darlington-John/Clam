...
useEffect(() => {
 ...
 <h1 className="fancy text-[43px] text-center lg:text-3xl">Forgot password</h1>
 <h1 className='text-[17px]   text-black  leading-6  text-center md:text-sm'>
 You’re about to reset your password. Enter your email so we send instructions to reset your password.
 </h1>
...
placeholder="Email address"
        ...
        <button  className={`bg-purple text-center text-sm  norm-mid  h-10 rounded-full text-white w-full    ${!check?'opacity-100 hover:ring ring-offset-2 hover:ring-[2px]  ring-purple duration-300':'opacity-40'}`} 
        disabled={submitting || check} onClick={handleSubmit}>
