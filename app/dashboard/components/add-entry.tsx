...
const AddEntry = () => {
     ...
     return (
          <div className="md:w-full overflow-x-auto  overflow-y-hidden min-h-[100px]">
               <div className="flex w-full items-center gap-4 justify-center  py-8  px-6    md:justify-auto   md:w-[700px] md:pb-4">
                    ...
                    >
                         ...
                         >
                              ...
                              <p className="text-sm text-center">
                                   You’d need to create a book to start
                                   recording your entries. Think of books like
                                   folders for your entries. You can create as
                    ...
                    >
                         ...
                         >
                              ...
                              <p className="text-sm text-center text-grey">
                                   All your entries go in a book. You can create
